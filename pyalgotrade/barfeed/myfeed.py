...
class RowParser(csvfeed.RowParser):
    ...
    def parseBar(self, csvRowDict):
        ...
        #adjfactor = float(csvRowDict['ADJFACTOR'])
        #turn = float(csvRowDict['TURN'])
        #trade_status = str(csvRowDict['TRADE_STATUS'])
        #susp_reason = str(csvRowDict['SUSP_REASON'])
        #maxupordown = bool(csvRowDict['MAXUPORDOWN'])
